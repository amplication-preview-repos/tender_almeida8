...
@InputType()
class PurchaseOrderCreateNestedManyWithoutSuppliersInput {
...
export { PurchaseOrderCreateNestedManyWithoutSuppliersInput as PurchaseOrderCreateNestedManyWithoutSuppliersInput };
